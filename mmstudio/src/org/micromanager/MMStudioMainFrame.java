...
//CVS:          $Id: MMStudioMainFrame.java 8639 2012-02-02 00:49:15Z henry $
//
...
//         acq.setSystemState(acq.getFrames() - 1, acq.getChannels() - 1, acq.getSlices() - 1, state);
   ...
   public void addTaggedImageAnalyzer(TaggedImageAnalyzer analyzer){
	   acqMgr_.addImageProcessor(analyzer);
   }
   
   public void removeTaggedImageAnalyzer(TaggedImageAnalyzer analyzer){
	   acqMgr_.removeImageProcessor(analyzer);
   }
